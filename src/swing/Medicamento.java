...
public class Medicamento extends JFrame {
	...
	public Medicamento() {
		...
		JLabel lblNewLabel = new JLabel("Setor de Medicamento");
		...
		JButton btnNewButton = new JButton("Cadastrar novo Medicamento");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CadastrarMedicamento novoFrame = new CadastrarMedicamento();
				novoFrame.dispose();
				String [] string = {};
				CadastrarMedicamento.main(string);
			}
		});
		...
		/*JButton btnNewButton_1 = new JButton("Listar Medicamentos cadastrados");
