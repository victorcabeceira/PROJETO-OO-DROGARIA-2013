...
public class Caixa extends JFrame {
	...
	public Caixa() {
		...
		JLabel lblNewLabel = new JLabel("Setor de Caixa");
		...
		JButton btnNewButton = new JButton("Cadastrar novo Caixa");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CadastrarCaixa novoFrame = new CadastrarCaixa();
				novoFrame.dispose();
				String [] string = {};
				CadastrarCaixa.main(string);
			}
		});
